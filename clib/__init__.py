...
class CloudRayIntersect(Function):
    ...
    def forward(ctx, radius, points, ray_start, ray_dir):
        ...
        inds, min_depth, max_depth = _ext.cloud_intersect(
            ray_start.float(), ray_dir.float(), points.float(), radius)
...
cloud_ray_intersect = CloudRayIntersect.apply
...
class _MeshFaceAreasNormals(Function):
    ...
    This function is taken from Pytorch3D
    ...
    def forward(ctx, verts, faces):
        ...
        areas, normals = _ext.face_areas_normals_forward(verts, faces)
    ...
    def backward(ctx, grad_areas, grad_normals):
        ...
        grad_verts = _ext.face_areas_normals_backward(
